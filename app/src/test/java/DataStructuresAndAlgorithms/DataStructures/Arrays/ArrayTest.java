...
class ArrayTest {
    ...
    void dynamicArrayGenericTest() {
        DynamicArray<String> arr_generic = new DynamicArray<>();
    ...
    public void testIndexOutOfBounds2() {
        ...
        assertThrows(IndexOutOfBoundsException.class, () -> list.removeAt(1000));
    }
    ...
    public void testIndexOutOfBounds4() {
        ...
        for (int i = 0; i < 15; i++)
            list.add(123);
        assertThrows(IndexOutOfBoundsException.class, () -> list.removeAt(-66));
    }
